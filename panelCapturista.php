...
<html lang="es">
    ...
    <body>
        ...
        <img src="owlBook.png" alt="">
        <p id="seccion">Panel Capturista</p><br>
        <p id="sseccion">Agregar Libro</p></div>                                     
        
        <div id="agregar">            
            <form class="search" action="agregarLibro.php" method="post">
                ...
                <input type="submit" name="search" value="Agregar">
            </form>
        </div>
